...
export default function TestLessonPage() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
            <div className="mb-6">
                <h1 className="text-3xl font-bold text-purple-700 mb-4">Chọn bài để kiểm tra</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="px-3 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-purple-500 cursor-pointer"
                        >
            ...
            {!loading && !error && lessons.length === 0 && (
                <div className="text-center py-12">
                    <p className="text-gray-500 text-lg">Chưa có bài học nào để kiểm tra.</p>
                </div>
            )}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-gradient-to-r from-purple-600 to-purple-500 text-white">
                                    <tr>
                                        <th
                                            className="px-6 py-4 text-left font-semibold cursor-pointer hover:bg-purple-700 transition-colors"
                                        ...
                                        <th
                                            className="px-6 py-4 text-left font-semibold cursor-pointer hover:bg-purple-700 transition-colors hidden md:table-cell"
                                        ...
                                        <th
                                            className="px-6 py-4 text-center font-semibold cursor-pointer hover:bg-purple-700 transition-colors"
                                        ...
                                        <th
                                            className="px-6 py-4 text-center font-semibold cursor-pointer hover:bg-purple-700 transition-colors hidden lg:table-cell"
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className="px-6 py-4">
                                                        ...
                                                        >
                                                            <div className="font-semibold text-purple-700 hover:text-purple-900 hover:underline">
                                                                {lesson.title}
                                                            </div>
